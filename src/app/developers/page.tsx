      ...
      <main className="max-w-4xl px-5 py-10 mx-auto sm:px-6">
        ...
        <div className="rounded-[28px] border border-black/10 bg-white p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-3 text-sm text-slate-500">
            Information for developers building around FaceGrem in the future.
          </p>
          ...
          <div className="mt-8 space-y-6 text-[15px] leading-7 text-slate-700">
            <section>
              ...
              <p className="mt-2">
                FaceGrem may introduce developer tools, APIs, and integrations as the
                platform grows.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                Public developer access is not yet available. This page exists to
                reserve the space for future documentation and integration guidance.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                Future developer features may include authentication support, content
                integrations, analytics access, or community-related tools.
              </p>
            </section>
          </div>
        </div>
