      ...
      <main className="max-w-4xl px-5 py-10 mx-auto sm:px-6">
        ...
        <div className="rounded-[28px] border border-black/10 bg-white p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-3 text-sm text-slate-500">
            Promotion and advertising tools for FaceGrem can live here in the future.
          </p>
          ...
          <div className="mt-8 space-y-6 text-[15px] leading-7 text-slate-700">
            <section>
              ...
              <p className="mt-2">
                This space can later be used for sponsored campaigns, boosted content,
                or business promotions across FaceGrem.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                FaceGrem may not currently provide a full advertising system, but this
                page is ready for future campaign creation tools.
              </p>
            </section>
          </div>
        </div>
